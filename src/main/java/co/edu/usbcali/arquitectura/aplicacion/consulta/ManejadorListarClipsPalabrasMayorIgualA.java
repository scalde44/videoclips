...
@Component
public class ManejadorListarClipsPalabrasMayorIgualA {
    private final DaoClip daoClip;

    public ManejadorListarClipsPalabrasMayorIgualA(DaoClip daoClip) {
        this.daoClip = daoClip;
    }

    public List<DtoClip> ejecutar(int cantidadPalabras) {
        return this.daoClip.listarClipsPalabrasMayorIgualA(cantidadPalabras);
    }
}
